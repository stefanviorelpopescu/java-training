...
public class ExchangeDesk {
    ...
    public <A extends Currency, B extends Currency> B convert(A givenCurrency, Class<B> convertedCurrencyClass) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    public <A extends Currency, B extends Currency> void addRate(Class<A> firstCurrency, Class<B> secondCurrency, double rate) {
        ...
        if (rate <= 0) {
            throw new IllegalArgumentException("Rate cannot be zero or less than 0");
        }
