...
Actor actorOsacar1990 = new Actor("actor cu 2 oscaruri",35,new Premiu[]{oscar1990,oscar2000});
...
Film film1 = new Film(1990, "film cu actori de oscar", new
        Actor[]{actorOsacar1990,actorFaraPremii01});
...
Database.moreThan2Movies(studioDatabase);
Database.moreThan2Reward(studioDatabase);
Database.atLeast50Age(studioDatabase);
