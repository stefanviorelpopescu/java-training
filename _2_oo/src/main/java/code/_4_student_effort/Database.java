...
public class Database {
    ...
    public static void studioThatPublishedMoreThan2Movies() {
    ...
    public static void studioNamesInWitchPlaysTheActorWithNameActorWith2Oscar() {
        for (Studio studio : getData())
    ...
    public static void movieNamesInWitchPlaysActorWithAgeAbove50() {
        for (Studio studio : getData()) {
            for (Film film : studio.filme) {
                for (Actor actor : film.actori) {
                    if (actor.varsta > 50) {
    ...
    public static void codeChallenge2() {
        studioThatPublishedMoreThan2Movies();
        studioNamesInWitchPlaysTheActorWithNameActorWith2Oscar();
        movieNamesInWitchPlaysActorWithAgeAbove50();
