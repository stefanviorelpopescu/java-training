...
public class MovieDatabase {
    ...
    private MovieDatabase() {
        ...
        this.studioDatabase = new Studio[]{studio1, studio2};
    }

    public void getStudioWithMoreThanTwoMovies() {
        for (Studio studio : this.studioDatabase) {
    ...
    public void getStudioInWhichPlaysTheActorWithTwoOscars() {
        for (Studio studio: this.studioDatabase) {
    ...
    public void getStudioWithActorOver50Years() {
        for (Studio studio: this.studioDatabase) {
            for (Film film: studio.filme) {
                for (Actor actor: film.actori) {
                    if (actor.varsta >= 50) {
    ...
    public static void main(String[] args) {
        ...
        database.getStudioWithMoreThanTwoMovies();
        System.out.println("Studios in which plays the actor with name actor with 2 oscaruri:");
        database.getStudioInWhichPlaysTheActorWithTwoOscars();
        System.out.println("Movie names in which plays at least an actor with age over 50 years: ");
        database.getStudioWithActorOver50Years();
    }
}
