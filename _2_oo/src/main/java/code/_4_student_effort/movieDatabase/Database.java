...
public class Database {
    ...
    public void getStudioNameWithMoreThan2Movies(){
        Studio[] studioDatabase;
        studioDatabase=this.getData();
    ...
    public void getStudioNameActorWithName(String name){
        Studio[] studioDatabase;
        studioDatabase=this.getData();
    ...
    public void getMovieNameWithActorAboveAge50(){
        Studio[] studioDatabase;
        studioDatabase=this.getData();
        for(Studio studio:studioDatabase){
            for(Film movie: studio.filme){
