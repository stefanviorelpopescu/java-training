...
public class Main {
    ...
    {
        Premiu oscar1990 = new Premiu("oscar", 1999);
        Premiu oscar2000 = new Premiu("oscar", 2000);
        Premiu oscar2010 = new Premiu("oscar", 2010);
        Premiu oscar2018 = new Premiu("oscar", 2018);

        Actor actorOscar1990 = new Actor ("actor2", 35, new Premiu[]{oscar1990,oscar2000});
        ...
        System.out.println("Urmatoarele studiouri au publicat mai mult de 2 filme: ");
        studio1.getName();
        studio2.getName();

        System.out.println(" ");
        System.out.println("Actorul cu numele .Actor2. joaca in cadrul urmatoarelor studiouri: ");
        studio1.getStudioName();
        studio2.getStudioName();

        System.out.println(" ");
        System.out.println("Filmele in care joaca actori de peste 50 de ani sunt: ");
        studio1.getMovieName();
        studio2.getMovieName();
