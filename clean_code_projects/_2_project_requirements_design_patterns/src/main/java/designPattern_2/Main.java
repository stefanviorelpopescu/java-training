...
// Am utilizat design patternul "Chain of Responsibility", care este un pattern comportamental care permite manipularea
// mai multor obiecte
//AM realizat un bancomat care poate sa ofere bancnote de 5,10,50,100,200 si 500 de lei, acestea fiind obiectele manipulate
...
public class Main {
    ...
    public Main(int lei500BanknoteNr, int lei200BanknoteNr, int lei100BanknoteNr, int lei50BanknoteNr, int lei10BanknoteNr, int lei5BanknoteNr)
    {
    ...
    {
        Main atmDispenser = new Main(1,2,3,4,5,6);
        while (true)
        {
            int amount = 0;
